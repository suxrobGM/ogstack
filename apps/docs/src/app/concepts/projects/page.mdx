...
The public OG endpoint (`GET /og/:publicId`) only renders for URLs whose origin matches one of the project's registered domains. This prevents someone from pointing your project at arbitrary URLs to burn through your quota.
