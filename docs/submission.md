...
- **Video demo**: <https://youtu.be/ThXnXZXLdk0>
...
- **C.L.E.A.R. PR review examples** - [`docs/pr-reviews/clear-examples.md`](./pr-reviews/clear-examples.md).
- **Pull request template** - [`.github/PULL_REQUEST_TEMPLATE.md`](../.github/PULL_REQUEST_TEMPLATE.md).
- **Test coverage report** - [Coverage Report](./test-coverage-report.pdf).
